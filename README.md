...
각 직원은 고유한 아바타와 성경 말씀을 담은 프로필 카드를 생성할 수 있습니다.
...
- 💾 **직원 정보 관리**: Firebase Realtime Database를 통한 실시간 데이터 저장
- 🔍 **직원 조회**: 이름 또는 팀명으로 직원 검색
- 📖 **성경 말씀**: 각 직원 카드에 100개의 암송 구절 중 하나가 랜덤으로 배정
